...
Gem::Specification.new do |gem|
  ...
  gem.add_runtime_dependency 'railties',        '>= 3.0', '<= 4.3'
  gem.add_runtime_dependency 'actionpack',      '>= 3.0', '<= 4.3'
  gem.add_runtime_dependency 'activesupport',   '>= 3.0', '<= 4.3'
  gem.add_development_dependency 'rails',       '>= 3.0', '<= 4.3'
